...
void main()
{
  ...
  do
  {
    ...
    stdout.write("\nEnter 1 Sum of all Element : \n");
    stdout.write("Enter 2 Sum of specific Row : \n");
    stdout.write("Enter 3 Sum of specific Colum : \n");
    stdout.write("Enter 4 Sum of Diagonal Element : \n");
    stdout.write("Enter 5 Sum of antidiagonal Element : \n");
...
{
 stdout.write("enter the value of column : ");
  int n=int.parse(stdin.readLineSync()!);
...
dynamic sum=0;
 ...
 {
  stdout.write("enter the valide input for column: ");
 }
